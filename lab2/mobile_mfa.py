...
class BioConnect:
	...
	def getAuthenticatorStatus(self):
		...
		# Extract the authenticator status for this mobile phone
		if reply.get("status")=="active" and (reply.get("face_status")=="enrolled" or 
						reply.get("voice_status")=="enrolled" or 
						reply.get("fingerprint_status")=="enrolled" or
						reply.get("eye_status")=="enrolled"):
			return "active"
	...
	def sendStepup(self,
		...
		if result == False:
			...
			print(json.dumps(data))
			print(result.content)
			sys.exit("Error: unable to push the authentication request to the mobile phone")
	...
	def getStepupStatus(self):
		...
		if result == False:
			...
			print(headers)
			print(result.content)
			sys.exit("Error: unable to get the stepup status")
		...
		try:
			...
			print(headers)
			print(result.content)
			sys.exit("Error: unexpected reply for the stepup status")
	
		# Extract and return the stepup status
		#print (len(reply))
